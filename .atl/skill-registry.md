...
## Skipped (internal/system skills)

- `_shared` — shared SDD references
- `customize-opencode` — opencode configuration
- `sdd-apply`, `sdd-archive`, `sdd-design`, `sdd-explore`, `sdd-init`, `sdd-onboard`, `sdd-propose`, `sdd-spec`, `sdd-tasks`, `sdd-verify` — SDD workflow skills (loaded by orchestrator)
- `skill-registry` — self
