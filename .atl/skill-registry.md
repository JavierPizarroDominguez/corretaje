...
| `crear-agente-opencode` | Trigger: crear agente, create agent, agregar agente, register agent opencode. Create OpenCode agents: file-based default, inline fallback, validation gates. | user | `C:\Users\Javier\.config\opencode\skills\crear-agente-opencode\SKILL.md` |
...
| `pdf` | Trigger: PDF, generar PDF, leer PDF, analizar archivo .pdf, extraer texto de PDF, archivo PDF, documento PDF, convertir a PDF, exportar PDF. Read and generate PDF files using bundled Python scripts. | user | `C:\Users\Javier\.config\opencode\skills\pdf\SKILL.md` |
