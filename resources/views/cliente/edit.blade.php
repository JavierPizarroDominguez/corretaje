...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" name="fecha_creacion" class="form-control" value="{{ old('fecha_creacion', $cliente->fecha_creacion) }}">
            @error('fecha_creacion') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
        <div class="mb-3">
            <label class="form-label">Rut</label>
            <input type="text" name="rut" class="form-control" value="{{ old('rut', $cliente->rut) }}">
        ...
        <div class="mb-3">
            ...
            @error('estado_civil') <span class="text-danger">{{ $message }}</span> @enderror
                ...
                <div class="d-flex gap-2 mt-4 pt-3 border-top">
                    ...
                    <a href="/cliente/{{ $cliente->id }}" class="btn btn-outline-secondary btn-sm">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
