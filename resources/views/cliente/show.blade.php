...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            ...
            <a href="/cliente" class="btn btn-outline-secondary btn-sm">Volver</a>
        </div>
    </div>
    ...
    <tr>
        <td><b>Nombre:</b></td>
        <td id="td-cliente-{{ $cliente->id }}-nombre">{{ $cliente->nombre }}</td>
    ...
    <tr>
        ...
        <td id="td-cliente-{{ $cliente->id }}-fecha_creacion">{{ $cliente->fecha_creacion }}</td>
    ...
    <tr>
        <td><b>Rut:</b></td>
        <td id="td-cliente-{{ $cliente->id }}-rut">{{ $cliente->rut }}</td>
    ...
    <tr>
        <td><b>Email:</b></td>
        <td id="td-cliente-{{ $cliente->id }}-email">{{ $cliente->email }}</td>
    ...
    <tr>
        <td><b>Ocupacion:</b></td>
        <td id="td-cliente-{{ $cliente->id }}-ocupacion">{{ $cliente->ocupacion }}</td>
    ...
    <tr>
        ...
        <td id="td-cliente-{{ $cliente->id }}-estado_civil">{{ $cliente->estado_civil }}</td>
