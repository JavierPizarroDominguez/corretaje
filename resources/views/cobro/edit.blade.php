...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" name="fecha_cobro" class="form-control" value="{{ old('fecha_cobro', $cobro->fecha_cobro) }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="monto" class="form-control" value="{{ old('monto', $cobro->monto) }}">
            @error('monto') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
        <div class="mb-3">
            <label class="form-label">Detalle</label>
            <input type="text" name="detalle" class="form-control" value="{{ old('detalle', $cobro->detalle) }}">
        ...
        <div class="mb-3">
            ...
            @endif
                ...
                <div class="d-flex gap-2 mt-4 pt-3 border-top">
                    ...
                    <a href="/cobro/{{ $cobro->id }}" class="btn btn-outline-secondary btn-sm">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
