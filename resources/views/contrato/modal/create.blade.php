{{--
    modal/create.blade.php — Formulario para crear Contrato en modal

    Uso desde la vista padre:
        <button type="button" class="btn btn-primary btn-sm"
                onclick="abrirModal({titulo: 'Nuevo contrato', vista: 'vista-crear-contrato'})">
            Agregar
        </button>

        <div class="d-none">
            <div id="vista-crear-contrato">
                @include('contrato.modal.create')
            </div>
        </div>
--}}

<form method="POST" action="/contrato" id="form-modal-create-contrato">
    @csrf
        <div class="mb-3">
