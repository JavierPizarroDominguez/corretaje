{{--
    modal/show.blade.php — Contenido para el modal de Contrato

    Uso desde la vista padre:
        <button type="button" class="btn btn-primary btn-sm"
                onclick="abrirModal({titulo: 'Contrato', vista: 'vista-contrato-{{ $contrato->id }}'})">
            Ver
        </button>

        <div class="d-none">
            <div id="vista-contrato-{{ $contrato->id }}">
                @include('contrato.modal.show', ['contrato' => $contrato])
            </div>
        </div>
--}}
