...
@section('content')
<div class="container">
    <h2>Editar participantecobro</h2>
    ...
    <div class="card">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="monto" class="form-control" value="{{ old('monto', $participanteCobro->monto) }}">
        ...
        <div class="mb-3">
            ...
            @error('rol') <span class="text-danger">{{ $message }}</span> @enderror
                ...
                <div class="d-flex gap-2 mt-4 pt-3 border-top">
                    ...
                    <a href="/participante_cobro/{{ $participanteCobro->cliente->id }}/{{ $participanteCobro->cobro->id }}" class="btn btn-outline-secondary btn-sm">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
