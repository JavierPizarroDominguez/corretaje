...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2>ParticipanteCobro #{{ $participanteCobro->cliente->id }}/{{ $participanteCobro->cobro->id }}</h2>
        <div>
            <a href="/participante_cobro/{{ $participanteCobro->cliente->id }}/{{ $participanteCobro->cobro->id }}/edit" class="btn btn-secondary btn-sm">Editar</a>
            <a href="/participante_cobro" class="btn btn-outline-secondary btn-sm">Volver</a>
        </div>
    </div>
