{{--
    modal/show.blade.php — Contenido para el modal de ParticipanteContrato

    Uso desde la vista padre:
        <button type="button" class="btn btn-primary btn-sm"
                onclick="abrirModal({titulo: 'ParticipanteContrato', vista: 'vista-participanteContrato-{{ $participanteContrato->id }}'})">
            Ver
        </button>

        <div class="d-none">
            <div id="vista-participanteContrato-{{ $participanteContrato->id }}">
                @include('participante_contrato.modal.show', ['participanteContrato' => $participanteContrato])
            </div>
        </div>
--}}
...
<div class="d-flex gap-2">
    <a href="/participante_contrato/{{ $participanteContrato->id }}"
