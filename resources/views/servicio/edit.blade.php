...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="dia_pago" class="form-control" value="{{ old('dia_pago', $servicio->dia_pago) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="numero_cliente" class="form-control" value="{{ old('numero_cliente', $servicio->numero_cliente) }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="monto_fijo" class="form-control" value="{{ old('monto_fijo', $servicio->monto_fijo) }}">
            @error('monto_fijo') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
                <div class="d-flex gap-2 mt-4 pt-3 border-top">
                    <button type="submit" class="btn btn-primary">Guardar</button>
                    <a href="/servicio/{{ $servicio->id }}" class="btn btn-outline-secondary btn-sm">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
