{{--
    modal/create.blade.php — Formulario para crear Servicio en modal

    Uso desde la vista padre:
        <button type="button" class="btn btn-primary btn-sm"
                onclick="abrirModal({titulo: 'Nuevo servicio', vista: 'vista-crear-servicio'})">
            Agregar
        </button>

        <div class="d-none">
            <div id="vista-crear-servicio">
                @include('servicio.modal.create')
            </div>
        </div>
--}}

<form method="POST" action="/servicio" id="form-modal-create-servicio">
    @csrf
        <div class="mb-3">
