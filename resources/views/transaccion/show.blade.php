...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="/transaccion/{{ $transaccion->id }}/edit" class="btn btn-secondary btn-sm">Editar</a>
            <a href="/transaccion" class="btn btn-outline-secondary btn-sm">Volver</a>
        </div>
    </div>
    ...
    <script>
    buscador({
        input: '#input-buscador-destino_transaccion',
        list:  '#listaBuscadorDestinoTransaccion',
        tipo:  'destino_transaccion',
        onSelect: function(item) {
            document.getElementById('input-buscador-destino_transaccion').value = item.texto;
            document.getElementById('input-buscador-destino_transaccion').closest('form').submit();
        }
    });

    buscador({
        input: '#input-buscador-origen_transaccion',
        list:  '#listaBuscadorOrigenTransaccion',
        tipo:  'origen_transaccion',
        onSelect: function(item) {
            document.getElementById('input-buscador-origen_transaccion').value = item.texto;
            document.getElementById('input-buscador-origen_transaccion').closest('form').submit();
        }
    });
    </script>
    @endpush
