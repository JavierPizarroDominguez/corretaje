...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nombre" class="form-control" value="{{ old('nombre', $unidad->nombre) }}">
        ...
        <div class="mb-3">
            ...
            @endif
                ...
                <div class="d-flex gap-2 mt-4 pt-3 border-top">
                    ...
                    <a href="/unidad/{{ $unidad->id }}" class="btn btn-outline-secondary btn-sm">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
